...
def record_video(output_folder=None, duration=30, resolution=(1920, 1080)):
    """
    ...
    try:
        ...
        if PICAMERA2_AVAILABLE:
            # Use Picamera2 (mirroring your image script's minimal config)
            camera = Picamera2()
        ...
        # Clean shutdown (like your close_camera)
        if camera:
            if PICAMERA2_AVAILABLE:
                camera.stop()
                camera.close()
